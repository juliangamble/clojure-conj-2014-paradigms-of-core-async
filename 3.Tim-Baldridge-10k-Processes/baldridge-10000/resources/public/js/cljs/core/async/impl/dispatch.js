...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11176 = 0;while(true){
var m_11177 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11177 == null))
{} else
{m_11177.call(null);
if((count_11176 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11178 = (count_11176 + 1);
count_11176 = G__11178;
continue;
}
} else
{}
