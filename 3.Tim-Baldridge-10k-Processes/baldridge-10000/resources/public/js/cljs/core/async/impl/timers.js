...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_11141 = 0;while(true){
if((i_11141 < arr.length))
{(arr[i_11141] = null);
{
...
{var i_11148 = (self__.level + 1);while(true){
if((i_11148 <= (new_level + 1)))
{(update[i_11148] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_11150 = 0;while(true){
if((i_11150 <= self__.level))
{var links_11151 = (update[i_11150]).forward;if(((links_11151[i_11150]) === x__$1))
{(links_11151[i_11150] = (x__$1.forward[i_11150]));
{
