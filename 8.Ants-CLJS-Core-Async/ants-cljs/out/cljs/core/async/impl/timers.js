...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_11397 = 0;while(true){
if((i_11397 < arr.length))
{(arr[i_11397] = null);
{
...
{var i_11404 = (self__.level + 1);while(true){
if((i_11404 <= (new_level + 1)))
{(update[i_11404] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_11406 = 0;while(true){
if((i_11406 <= self__.level))
{var links_11407 = (update[i_11406]).forward;if(((links_11407[i_11406]) === x__$1))
{(links_11407[i_11406] = (x__$1.forward[i_11406]));
{
var G__11408 = (i_11406 + 1);
i_11406 = G__11408;
continue;
}
} else
{{
var G__11409 = (i_11406 + 1);
i_11406 = G__11409;
continue;
}
}
