...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15940 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15940 = (function (val,box,meta15941){
this.val = val;
this.box = box;
this.meta15941 = meta15941;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t15940.cljs$lang$type = true;
cljs.core.async.impl.channels.t15940.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15940";
cljs.core.async.impl.channels.t15940.cljs$lang$ctorPrWriter = (function (this__4033__auto__,writer__4034__auto__,opt__4035__auto__){return cljs.core._write.call(null,writer__4034__auto__,"cljs.core.async.impl.channels/t15940");
});
cljs.core.async.impl.channels.t15940.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15940.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15942){var self__ = this;
var _15942__$1 = this;return self__.meta15941;
});
cljs.core.async.impl.channels.t15940.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15942,meta15941__$1){var self__ = this;
var _15942__$1 = this;return (new cljs.core.async.impl.channels.t15940(self__.val,self__.box,meta15941__$1));
});
cljs.core.async.impl.channels.__GT_t15940 = (function __GT_t15940(val__$1,box__$1,meta15941){return (new cljs.core.async.impl.channels.t15940(val__$1,box__$1,meta15941));
});
}
return (new cljs.core.async.impl.channels.t15940(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_15943 = self__.takes.pop();if((taker_15943 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15943))
{var take_cb_15944 = cljs.core.async.impl.protocols.commit.call(null,taker_15943);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15944,taker_15943){
return (function (){return take_cb_15944.call(null,null);
});})(take_cb_15944,taker_15943))
);
} else
{}
{
