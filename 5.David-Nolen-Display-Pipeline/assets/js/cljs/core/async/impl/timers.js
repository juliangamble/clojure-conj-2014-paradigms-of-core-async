...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_15899 = 0;while(true){
if((i_15899 < arr.length))
{(arr[i_15899] = null);
{
...
{var i_15906 = (self__.level + 1);while(true){
if((i_15906 <= (new_level + 1)))
{(update[i_15906] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15908 = 0;while(true){
if((i_15908 <= self__.level))
{var links_15909 = (update[i_15908]).forward;if(((links_15909[i_15908]) === x__$1))
{(links_15909[i_15908] = (x__$1.forward[i_15908]));
{
var G__15910 = (i_15908 + 1);
i_15908 = G__15910;
continue;
}
} else
{{
var G__15911 = (i_15908 + 1);
i_15908 = G__15911;
continue;
}
}
