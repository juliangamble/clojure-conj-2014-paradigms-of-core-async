...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15934 = 0;while(true){
var m_15935 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15935 == null))
{} else
{m_15935.call(null);
if((count_15934 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15936 = (count_15934 + 1);
count_15934 = G__15936;
continue;
}
} else
{}
