...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13852 = 0;while(true){
var m_13853 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13853 == null))
{} else
{m_13853.call(null);
if((count_13852 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13854 = (count_13852 + 1);
count_13852 = G__13854;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3463__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3463__auto__)
