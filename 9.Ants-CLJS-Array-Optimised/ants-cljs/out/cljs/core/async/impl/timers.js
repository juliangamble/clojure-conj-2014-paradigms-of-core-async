...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4042__auto__,writer__4043__auto__,opt__4044__auto__){return cljs.core._write.call(null,writer__4043__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13817 = 0;while(true){
if((i_13817 < arr.length))
{(arr[i_13817] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4042__auto__,writer__4043__auto__,opt__4044__auto__){return cljs.core._write.call(null,writer__4043__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13824 = (self__.level + 1);while(true){
if((i_13824 <= (new_level + 1)))
{(update[i_13824] = self__.header);
{
var G__13825 = (i_13824 + 1);
i_13824 = G__13825;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13826 = 0;while(true){
if((i_13826 <= self__.level))
{var links_13827 = (update[i_13826]).forward;if(((links_13827[i_13826]) === x__$1))
{(links_13827[i_13826] = (x__$1.forward[i_13826]));
{
var G__13828 = (i_13826 + 1);
i_13826 = G__13828;
continue;
}
} else
{{
var G__13829 = (i_13826 + 1);
i_13826 = G__13829;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3475__auto__ = (cljs.core.truth_((function (){var and__3463__auto__ = me;if(cljs.core.truth_(and__3463__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3463__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3475__auto__))
