...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11432 = 0;while(true){
var m_11433 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11433 == null))
{} else
{m_11433.call(null);
if((count_11432 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11434 = (count_11432 + 1);
count_11432 = G__11434;
continue;
}
} else
{}
